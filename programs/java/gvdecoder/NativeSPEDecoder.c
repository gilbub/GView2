...
JNIEXPORT jint JNICALL Java_gvdecoder_NativeSPEDecoder_UpdateImageArray (JNIEnv *env, jobject obj, jintArray arr, jint xdim, jint ydim, jint spenum)
{
int i;
...
JNIEXPORT jint JNICALL Java_gvdecoder_NativeSPEDecoder_JumpToFrame(JNIEnv *env, jobject obj, jint frame, jint instance)
{
...
JNIEXPORT jint JNICALL Java_gvdecoder_NativeSPEDecoder_OpenImageFile(JNIEnv *env, jobject obj, jstring name)
{
int i;
...
JNIEXPORT jint JNICALL Java_gvdecoder_NativeSPEDecoder_CloseImageFile(JNIEnv *env, jobject obj, jint instance)
{
...
JNIEXPORT jint JNICALL Java_gvdecoder_NativeSPEDecoder_FilterOperation(JNIEnv *env, jobject obj, jint val, jint startx, jint endx, jint instance)
{
 int i;
 int len;
...
JNIEXPORT jstring JNICALL Java_gvdecoder_NativeSPEDecoder_ReturnSupportedFilters(JNIEnv *env, jobject obj)
{
...
JNIEXPORT jint JNICALL Java_gvdecoder_NativeSPEDecoder_ReturnFrameNumber(JNIEnv *env, jobject obj)
{
...
JNIEXPORT jint JNICALL Java_gvdecoder_NativeSPEDecoder_ReturnXYBandsFrames(JNIEnv *env , jobject obj, jintArray arr, jint instance)
{
jboolean isCopy = JNI_FALSE;
jint* body = (jint*) (*env)->GetPrimitiveArrayCritical(env,arr, &isCopy);
...
JNIEXPORT jint JNICALL Java_gvdecoder_NativeSPEDecoder_SumROIs(JNIEnv *env, jobject obj, jobjectArray rois, jstring outfile, jint startframe, jint endframe, jint instance){
