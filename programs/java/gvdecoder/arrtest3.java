...
public double[] __getitem__(int val){
	if (val>10)
...
public void __setitem__(int val, double[] arr){
 System.out.println("setting index "+val+" to array length = "+arr.length);
 return "setting index "+val+" to array length = "+arr.length;
}
