...
public class SacconiHelper5{
 ...
 public void MultiTifftoGv(gvdecoder.Viewer2 vw, int start, int end, String filename){
	 	 int ydim=400;
	 	 int zdim=end-start;
	 	 int xdim=400*7;
	 	 int x,y,z,c;
	 	 ...
	 	 MappedByteBuffer buffer = fc.map (FileChannel.MapMode.READ_WRITE, 0, 2*zdim*xdim*ydim+4*4);
