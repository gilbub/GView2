package gvdecoder;
 import java.io.*;
 import java.util.*;
 import gvdecoder.array.circularDoubleArray3D;
/**
 **/
public class MultiMatrixDatafileDecoder extends Matrix implements ImageDecoder{
   ...
   public MultiMatrixDatafileDecoder(String filetype){
   ...
   public  int UpdateImageArray(int[] arr,int xdim,int ydim, int instance){
	   ...
	   ((gvdecoder.array.circularDoubleArray3D)dat).addFrame(arr);
	   return 1;
	   }
  ...
  public boolean FiletypeSupported(){
   ...
   public  int OpenImageFile(String filename){
	   ...
	   create(1000,ydim,xdim);
       circularDoubleArray3D circ=new circularDoubleArray3D(1000,ydim,xdim);
       dat=circ;
       return 1;
	   }
	   else{
