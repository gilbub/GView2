...
public class Viewer2 extends JInternalFrame implements ActionListener, ImageViewer{
	...
	String filetype;
	ImageDecoder im;
	int[] viewArray;//the scaled image mod 256 etc.
	int[] datArray; //actual data
	double[] normalize=null;
	...
	float viewScale;  //calculated value for x,y scaling
    ...
    Viewer2(GView ifd, int fps, String filename, String absolutefilename, String filetype) {
       super(filename,
	                 true, //resizable
	                 true, //closable
	                 true, //maximizable
	   ...
	   viewArray=new int[X_dim*Y_dim];
		...
		JSplitPane splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,
		  ...
		  viListener vilistener = new viListener(this);
				  ...
				  JMenuItem menuItem = new JMenuItem("create navigator");
  ...
  if (nav!=null){
   ...
   public void loadROIs(){
	...
	public void createUnitRoi(){
		...
		jp.presentroi=new ROI(this,new Color((int)(Math.random()*255),(int)(Math.random()*255),(int)(Math.random()*255)));
