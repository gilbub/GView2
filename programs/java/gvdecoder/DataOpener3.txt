 ...
 public DoubleBuffer OpenImageFile(String filename, int position){
		try{
			 ...
			 MappedByteBuffer buffer = fc.map (FileChannel.MapMode.READ_ONLY, position, fc.size()-position);
