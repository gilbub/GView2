...
/**
	...
	The method ReturnSupportedFilters() should return a formatted string that explains what each toggle
	does, and what the state of each filter is.
...
public interface ImageDecoder{
   ...
   public int ReturnXYBandsFrames(int[] dat);
