...
public class APDetector3 extends function{
	double highthresh;
	double lowthresh;
	int zplus;
	int zminus;
...
public APDetector3(double highthresh, double lowthresh, int zminus, int zplus, int yminus, int yplus, int xminus, int xplus){
