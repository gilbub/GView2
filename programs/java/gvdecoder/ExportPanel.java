 ...
 * @author  Gil
 */
public class ExportPanel extends javax.swing.JPanel implements StatusMonitor {
    Viewer2 vw;
   ...
   public void showProgress(double val){
	   SwingUtilities.invokeLater(new Runnable(){
		public void run(){
        if (val==0.0) progressbar.setStringPainted(false);
        if (val==1.0) progressbar.setStringPainted(true);
	   	if (progressbar!=null){
	   		  progressbar.setValue((int)(val*100));
	   		  java.awt.Rectangle rect=progressbar.getBounds();
	   		  rect.x=0;
	   		  rect.y=0;
  ...
  public boolean isCancelled(){
    ...
    private void initComponents() {
        ...
        java.awt.Font sfont=new java.awt.Font("Arial", 0, 9);
        //qtc=new QTCodecs();
        ...
        jLabel1.setFont(sfont);
        jLabel1.setText("start");
        jPanel2.add(jLabel1);
        jLabel1.setBounds(10, 20, 30, 13);

        jLabel2.setFont(sfont);
       ...
       // endRange.setText("-1");
        ...
        jLabel3.setFont(sfont);
        jLabel3.setText("skip");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(120, 20, 30, 13);

        jLabel4.setFont(sfont);
        sumFrames.setFont(sfont);
        sumFrames.setText("1");
       ...
       if ((vw.im.ReturnSupportedFilters()).indexOf("FRAMESTEP")==-1){
        ...
        sizeToRealPixels.setFont(sfont);
        ...
        AVIUnfilteredCheckBox.setFont(sfont);
        ...
        startEncoding.setBounds(0, 78, 50, 24);

        cancelEncoding.setBackground(new java.awt.Color(255, 153, 153));
        cancelEncoding.setFont(sfont);
        ...
        cancelEncoding.setBounds(50, 78, 50, 24);

        saveAsDefaults.setFont(sfont);
