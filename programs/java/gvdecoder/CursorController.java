...
public class CursorController extends JPanel
    ...
    GView gv;
    public String[] info; //used by CursorData
    public int test=10;
	 ...
	 windowSize=this.getSize();
  	...
  	this.setLayout(new BorderLayout()); //unnecessary
            ...
            y3field=new JTextField(5);
             ...
             CursorData=new infopanel();
             CursorData.cc=this;
             CursorData.setPreferredSize(new Dimension(70,100));
             CursorData.setSize(70,100);
             this.add(CursorData,BorderLayout.WEST);
...
class infopanel extends JPanel{
	...
	public void paintComponent(Graphics g){
	 ...
	 for (int i=0;i<cc.info.length;i++){
	   g.drawString(cc.info[i],1,i*20);
     }
	}
   }
