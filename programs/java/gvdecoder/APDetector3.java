...
public class APDetector4 extends function{
	double highthresh;
	double lowthresh;
	int zplus;
	int zminus;
...
public APDetector4(double highthresh, double lowthresh, int zminus, int zplus, int yminus, int yplus, int xminus, int xplus){
