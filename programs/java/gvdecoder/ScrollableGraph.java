...
import java.io.*;
/*
 Paints several lines on the same graph. Should allow for individual scaling.
 It uses drawPolyLine(arrayx, arrayy, length)
 */


class MultiGraph extends JPanel {
    ...
    public MultiGraph(String absolutefilename, Viewer2 vw) {
     this.vw=vw;
...
class menuListener implements ActionListener{
 ...
 public void actionPerformed(ActionEvent e) {
		...
		//sg.vw.im.JumpToFrame(sg.user_start,sg.vw.instance);
